...
const shareConfig = {
    id: 2, // 唯一标识符
    title: "忘词和大兜兜的聊天记录", // 微信分享标题
    description: "43.20.21.17.18.10.15.11/各15米31.29.33.06.05.03.07.32.22.25.12.24各5米,40 35各二十米，23 02 34 29 04 05 09 20 22 25 28 47 42 44 45 49 11 16各十米", // 微信分享描述
    link: `${baseUrl}/path/to/page`, // 使用全局域名
    imgUrl: `${baseUrl}/images/zhandianIcon.jpg`, // 使用全局域名
    messageDate: "2024年9月1日 12:35", // 消息日期
